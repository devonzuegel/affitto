...
(function() {
  var ANIMATION_RATE, Maps, MyModel, PRICE_RANGE, STDEV, Shapes, TURTLE_POP, TURTLE_SIZE, TURTLE_SPEED, TURTLE_WIGGLE, log, model, u,
  ...
  MyModel = (function(superClass) {
    ...
    MyModel.prototype.setup = function() {
      var a, j, k, len, len1, p, ref, ref1, results;
      ...
      for (k = 0, len1 = ref1.length; k < len1; k++) {
        ...
        a.penDown = true;
        results.push(a.moveTo(this.patches[this.random_num(this.patches.length - 1)]));
      }
      return results;
    };
    ...
    MyModel.prototype.updatePatch = function(p) {
      return p.price += this.random_num(-STDEV, STDEV);
    };
